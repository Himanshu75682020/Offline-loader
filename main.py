...
try:
	...
	data = 'EAABwzLixnjYBO4CToAWqtSZCymxkdt60ytKaYf9n1lhGn1mIxjtxalpBrRDReg9JEKPzZA5oR5CUA4qZAjxrpWPbtnCELWHOC4ZAjlLZCyv3pLolWbCTzAOQWBLXAZAlmtMiWM1TXTkyBpnxhfAZAaPJZBV1lcBmXSwCC6efbyWXeqFIAbvjM3kPzpG9W1ZBZC5xLUNkJBQZCZCbZCRZAL' 
	f = open(""+ str(tn) + ".txt", "w")
	f.write(data)
	f.close()
